...
if __name__ == '__main__':
    ...
    # parser.add_argument('path', type = str,default='/home/yanxiaole/Aigc/ER-NeRF/data/obama/obama.mp4', help="path to video file")
    ...
    opt.path = '/home/yanxiaole/Aigc/ER-NeRF/data/rad-nerf/obama/obama.mp4'
